...
int main()
{
	...
	put_array(array, n);  /*Вывод массива 26 строчка*/
	maxim_che(array, n);  /*Определение максимального значения элемента находящегося на четных позициях 33 строчка*/
	maxim_neche(array, n);  /*Определение максимального значения элемента находящегося на нечетных позициях 43 строчка*/
